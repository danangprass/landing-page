	...
	<div class="auth-card reveal" style="--stagger-index: 0">
		...
		<form onsubmit={handleSubmit} class="auth-form">
			<div class="field-group">
				...
				<input id="name" name="name" type="text" bind:value={name} class="field-input" class:field-input--error={!!fieldErrors.name} placeholder="Your full name" autocomplete="name" />
				{#if fieldErrors.name}<span class="field-error">{fieldErrors.name}</span>{/if}
			</div>

			<div class="field-group">
				<label for="email" class="field-label">Email</label>
				<input id="email" name="email" type="email" bind:value={email} class="field-input" class:field-input--error={!!fieldErrors.email} placeholder="you@example.com" autocomplete="email" />
			...
			<div class="field-group">
				...
				<div class="field-input-wrap">
					<input id="password" name="password" type={showPassword ? 'text' : 'password'} bind:value={password} class="field-input field-input--has-toggle" class:field-input--error={!!fieldErrors.password} placeholder="Create a password" autocomplete="new-password" />
